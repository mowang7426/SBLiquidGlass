...
if [[ "$MODE" == "sim" ]]; then
    ...
    cp -r .theos/obj/iphone_simulator/debug/SBLiquidGlassPrefs.bundle /opt/simject/PreferenceBundles/
    cp SBLiquidGlassPrefs/layout/Library/PreferenceLoader/Preferences/SBLiquidGlassPrefs.plist /opt/simject/PreferenceLoader/Preferences/
    resim
fi
