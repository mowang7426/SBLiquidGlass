...
static NSString *lgPrefsPath(void) {
    ...
    dispatch_once(&once, ^{
        cached = jbroot(@"/var/mobile/Library/Preferences/dylv.sbliquidglassprefs.plist");
    });
    return cached;
}
static NSString * const kLGPrefsReloadNote = @"dylv.sbliquidglassprefs/Reload";
